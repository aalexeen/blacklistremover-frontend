...
<template>
    <div class="bg-white rounded-xl shadow-md relative">
        <div class="p-4">
            <div class="mb-6">
                <div class="text-gray-600 my-2 font-mono"><span v-html="highlightMac"></span></div>
                <h3 class="text-xl font-bold">{{ mac.reason }}</h3>
            </div>
            ...
            <div class="mb-5">
                ...
                <button @click="toggleFullBlockTime" class="text-green-500 hover:text-green-600 mb-5">
                    {{ showFullBlockTime ? 'Less' : 'More' }}
                </button>
            </div>


            <h3 class="text-green-500 mb-2">{{ mac.remainingTime }}</h3>
